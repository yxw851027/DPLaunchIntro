    ...
    if (self) {
        ...
        if (isIphone4) {
            ...
            [titleImageView makeConstraints:^(MASConstraintMaker *make) {
                make.centerX.equalTo(weakSelf.centerX).offset(-(kScreenWidth + 125)/2.f);
            ...
            [titleImageView makeConstraints:^(MASConstraintMaker *make) {
                make.centerX.equalTo(weakSelf.centerX).offset(-(kScreenWidth + 160)/2.f);
        ...
        NSURL *url = [[NSBundle mainBundle] URLForResource:@"intro_video_2" withExtension:@"mov"];
